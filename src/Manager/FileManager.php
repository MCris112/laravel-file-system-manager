...
class FileManager extends AbstractManager
{
    ...
    function delete(): void
    {
        ...
        DB::transaction(function (){
            $this->parent->variations()->delete();
            $this->parent->delete();
        });
    }

    public function get(): FmFile|null
    {
        return parent::get(); // TODO: Change the autogenerated stub
    }

    /**
     * Get the variation of the file or just create it
     * @param FmFileSize|string $sizeType
    ...
    public function variation(FmFileSize|string $sizeType,  int|null $createdBy = null, int $quality = 8,  int $width = 0, int $height = 0): FmFile
    {
        ...
        if($sizeType instanceof FmFileSize) $size = $sizeType->value;

        if($this->parent->size_type == FmFileSize::THUMBNAIL->value) return $this->parent;
